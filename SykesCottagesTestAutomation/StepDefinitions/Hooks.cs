...
namespace SykesCottagesTestAutomation
{
    ...
    public class Hooks : MethodLibrary
    {
        ...
        public static string reportName = "TOBSmokeTest"; //Name of the report: LYPRegressionSuite | LYPSmokeTest | TOBSmokeTest | ActiveExperiments | DigitalOnboarding | FormSubmission
